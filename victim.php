...
<body>
    <div class="container">
        ...
        <button class="btn" onclick="location.href='helpline.php'">Joruri helpline</button>
        <button class="btn" onclick="location.href='victim_registration.php'">Fill up joruri form</button>
        <button class="btn" onclick="location.href='Shelter_locator.php'">Nearby shelter locator</button>
    </div>
</body>
</html>
